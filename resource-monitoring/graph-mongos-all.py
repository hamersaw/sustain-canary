...
data_files = [
    'data/lattice-100/45-129.82.208.56.nmon.csv',
    'data/lattice-100/46-129.82.208.57.nmon.csv']
legend_plots=[]
...
ax[0].set_title('Representative MongoS CPU', fontsize=11, fontweight='bold')
ax[0].set_ylabel('CPU Utilization (%)', fontsize=11)
ax[0].grid(linestyle=':')

ax[1].set_title('Representative MongoS RAM', fontsize=11, fontweight='bold')
ax[1].set_ylabel('Memory Utilization (GB)', fontsize=11)
ax[1].grid(linestyle=':')

ax[2].set_title('Representative MongoS Network I/O: eno1-write', fontsize=11, fontweight='bold')
ax[2].set_ylabel('Network I/O (MB/s)', fontsize=11)
ax[2].grid(linestyle=':')

ax[3].set_title('Representative MongoS Network I/O: eno1-read', fontsize=11, fontweight='bold')
...
fig.tight_layout()
fig.savefig('/tmp/mongos-all.pdf', dpi=300)
